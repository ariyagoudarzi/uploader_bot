...
class Bot(Client):
    ...
    async def start(self):
        try:
            ...
            self.LOGGER(__name__).info(
                "Bot Stoped.https://t.me/sshdiiofficial for help"
            )
            sys.exit()
        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).warning(
                    "Bot camt take invite link from FORCE_SUB_CHANNEL!"
                )
                self.LOGGER(__name__).warning(
        ...
        if FORCE_SUB_GROUP:
            try:
                ...
                self.LOGGER(__name__).warning(a)
                self.LOGGER(__name__).warning(
                    "Bot cant take invite link from FORCE_SUB_GROUP!"
                )
                self.LOGGER(__name__).warning(
